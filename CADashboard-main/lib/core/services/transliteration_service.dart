...
class TransliterationService {
  ...
  "day": "डे",
  "time": "टाइम",
  "today's date": "टुडेज डेट",
  "today's day": "टुडेज डे",
  "current time": "करंट टाइम",
  "first sign in": "फर्स्ट साइन इन",
  "last sign out": "लास्ट साइन आउट",
  ...
  "referred by": "रेफर्ड बाय",
  "company name": "कंपनी नेम",
  "first name": "फर्स्ट नेम",
  "last name": "लास्ट नेम",
  "client name": "क्लाइंट नेम",
  "client type": "क्लाइंट टाइप",
  "client supply type": "क्लाइंट सप्लाई टाइप",
  "client joining date": "क्लाइंट जॉइनिंग डेट",
  "select client joining date": "सिलेक्ट क्लाइंट जॉइनिंग डेट",
  "std code": "एसटीडी कोड",
  "firm type": "फर्म टाइप",
  "industry type": "इंडस्ट्री टाइप",
  "group type": "ग्रुप टाइप",
  ...
  "total": "टोटल",
  "currency": "करेंसी",
  "task add successfully": "टास्क ऐडेड सक्सेसफुल",
  "logs": "लॉग्स",
  "select": "सिलेक्ट",
  "new folder": "न्यू फोल्डर",
  "new subfolder": "न्यू सब फोल्डर",
  "upload files": "अपलोड फाइल्स",
  "download files": "डाउनलोड फाइल्स",
  "download folder": "डाउनलोड फोल्डर",
  "download": "डाउनलोड",
  "share": "शेयर",
  "share document": "शेयर डॉक्युमेंट",
  "un-share document": "अनशेयर डॉक्युमेंट",
  "view": "व्यू",
  "view / preview": "व्यू / प्रीव्यू",
  "unlock document": "अनलॉक डॉक्युमेंट",
  "lock document": "लॉक डॉक्युमेंट",
  "take photo": "टेक फोटो",
  "scan photo": "स्कैन फोटो",
  "scan document": "स्कैन डॉक्युमेंट",
  "rename": "रीनेम",
  ...
  static const Map<String, String> _uiGlossaryMr = {
    ...
    'notifications & reminders': 'नोटिफिकेशन्स अँड रिमाइंडर्स',
    'privacy policy': 'प्रायव्हसी पॉलिसी',
    'terms & condition': 'टर्म्स अँड कंडिशन्स',
    'delete my account': 'डिलीट माय अकाउंट',
    'name': 'नाव',
    'account receivable': 'अकाउंट रिसीवेबल',
    ...
    'add client': 'ॲड क्लायंट',
    'update client': 'अपडेट क्लायंट',
    'add task': 'ॲड टास्क',
    'add sub task': 'ॲड सब टास्क',
    'update task': 'अपडेट टास्क',
    'update sub task': 'अपडेट सब टास्क',
    'sub tasks': 'सब टास्क',
    'username': 'यूज़रनेम',
    ...
    'last name': 'लास्ट नेम',
    'client name': 'क्लाइंट नेम',
    'please select client supply type': 'कृपया क्लाइंट सप्लाई टाइप निवडा',
    'please select branch name': 'कृपया ब्रांच नेम निवडा',
    'please select group type': 'कृपया ग्रुप टाइप निवडा',
    'please select industry type': 'कृपया इंडस्ट्री टाइप निवडा',
    'please select firm type': 'कृपया फर्म टाइप निवडा',
    'please select std code': 'कृपया एसटीडी कोड निवडा',
    'please select client type': 'कृपया क्लाइंट टाइप निवडा',
    'select client joining date': 'सिलेक्ट क्लाइंट जॉइनिंग डेट',
    'client joining date': 'क्लाइंट जॉइनिंग डेट',
    'client supply type': 'क्लाइंट सप्लाई टाइप',
    'client type': 'क्लाइंट टाइप',
    ...
    'status': 'स्टेटस',
    'email': 'ईमेल',
    'employee3': 'एम्प्लॉई 3',
    'employee2': 'एम्प्लॉई 2',
    'employee': 'एम्प्लॉई',
    'home': 'होम',
    'about us': 'अबाउट अस',
    'camera': 'कॅमेरा',
  ...
  static const Map<String, String> _uiGlossaryGu = {
    ...
    'day': 'ડે',
    'time': 'ટાઇમ',
    "today's date": "ટુડેઝ ડેટ",
    "today's day": "ટુડેઝ ડે",
    'current time': 'કરંટ ટાઇમ',
    "first sign in": "ફર્સ્ટ સાઇન ઇન",
    "last sign out": "લાસ્ટ સાઇન આઉટ",
    ...
    'company name': 'કંપની નેમ',
    'first name': 'ફર્સ્ટ નેમ',
    'last name': 'લાસ્ટ નેમ',
    'client type': 'ક્લાયન્ટ ટાઈપ',
    'client supply type': 'ક્લાયન્ટ સપ્લાય ટાઈપ',
    'client joining date': 'ક્લાયન્ટ જોઇનિંગ ડેટ',
    'select client joining date': 'સિલેક્ટ ક્લાયન્ટ જોઇનિંગ ડેટ',
    'std code': 'એસટીડિ કોડ',
    'firm type': 'ફર્મ ટાઈપ',
    'industry type': 'ઇન્ડસ્ટ્રી ટાઈપ',
    'group type': 'ગ્રુપ ટાઈપ',
    'branch name': 'બ્રાન્ચ નેમ',
    'phone number': 'ફોન નંબર',
    'email': 'ઈમેલ',
    'pan number': 'પેન નંબર',
    'file number': 'ફાઈલ નંબર',
    'referred by': 'રેફર્ડ બાય',
    ...
    'client info': 'ક્લાયન્ટ ઇન્ફો',
    'address': 'એડ્રેસ',
    'owner details': 'ઓનર ડિટેલ્સ',
    'add task': 'એડ ટાસ્ક',
    'add sub task': 'એડ સબ ટાસ્ક',
    'update task': 'અપડેટ ટાસ્ક',
    'add client': 'એડ ક્લાયન્ટ',
    'update client': 'અપડેટ ક્લાયન્ટ',
    ...
    'total': 'ટોટલ',
    'currency': 'કરન્સી',
    'task add successfully': 'ટાસ્ક એડેડ સક્સેસફુલ',
    'logs': 'લોગ્સ',
    'select': 'સિલેક્ટ',
    'new folder': 'ન્યૂ ફોલ્ડર',
    'new subfolder': 'ન્યૂ સબ ફોલ્ડર',
    'upload files': 'અપલોડ ફાઇલ્સ',
    'download files': 'ડાઉનલોડ ફાઇલ્સ',
    'download folder': 'ડાઉનલોડ ફોલ્ડર',
    'download': 'ડાઉનલોડ',
    'share document': 'શેર ડોક્યુમેન્ટ',
    'un-share document': 'અનશેર ડોક્યુમેન્ટ',
    'share': 'શેર',
    'view': 'વ્યૂ',
    'view / preview': 'વ્યૂ / પ્રીવ્યૂ',
    'unlock document': 'અનલોક ડોક્યુમેન્ટ',
    'lock document': 'લોક ડોક્યુમેન્ટ',
    'take photo': 'ટેક ફોટો',
    'scan photo': 'સ્કેન ફોટો',
    'scan document': 'સ્કેન ડોક્યુમેન્ટ',
    'rename': 'રીનેમ',
    'something went wrong': 'સમથિંગ વેન્ટ રૉંગ',
  };
  ...
  static const Map<String, String> _uiGlossaryKn = {
    ...
    'day': 'ಡೇ',
    'time': 'ಟೈಮ್',
    "today's date": "ಟುಡೇಸ್ ಡೇಟ್",
    "today's day": "ಟುಡೇಸ್ ಡೇ",
    'current time': 'ಕರಂಟ್ ಟೈಮ್',
    "first sign in": "ಫರ್ಸ್ಟ್ ಸೈನ್ ಇನ್",
    "last sign out": "ಲಾಸ್ಟ್ ಸೈನ್ ಔಟ್",
    ...
    'assignor': 'ಅಸೈನರ್',
    'reviewer': 'ರಿವ್ಯೂಅರ್',
    'company name': 'ಕಂಪನಿ ನೇಮ್',
    'first name': 'ಫಸ್ಟ್ ನೇಮ್',
    'last name': 'ಲಾಸ್ಟ್ ನೇಮ್',
    'client type': 'ಕ್ಲೈಯಂಟ್ ಟೈಪ್',
    'client supply type': 'ಕ್ಲೈಯಂಟ್ ಸಪ್ಲೈ ಟೈಪ್',
    'client joining date': 'ಕ್ಲೈಯಂಟ್ ಜಾಯಿನಿಂಗ್ ಡೇಟ್',
    'select client joining date': 'ಸಿಲೆಕ್ಟ್ ಕ್ಲೈಯಂಟ್ ಜಾಯಿನಿಂಗ್ ಡೇಟ್',
    'std code': 'ಎಸ್‌ಟಿಡಿ ಕೋಡ್',
    'firm type': 'ಫರ್ಮ್ ಟೈಪ್',
    'industry type': 'ಇಂಡಸ್ಟ್ರಿ ಟೈಪ್',
    'group type': 'ಗ್ರೂಪ್ ಟೈಪ್',
    'branch name': 'ಬ್ರಾಂಚ್ ನೇಮ್',
    'phone number': 'ಫೋನ್ ನಂಬರ್',
    'email': 'ಇಮೇಲ್',
    'pan number': 'ಪ್ಯಾನ್ ನಂಬರ್',
    'file number': 'ಫೈಲ್ ನಂಬರ್',
    'referred by': 'ರೆಫರ್ಡ್ ಬೈ',
    ...
    'client info': 'ಕ್ಲೈಯಂಟ್ ಇನ್ಫೋ',
    'address': 'ಅಡ್ರೆಸ್',
    'owner details': 'ಓನರ್ ಡೀಟೇಲ್ಸ್',
    'add task': 'ಆಡ್ ಟಾಸ್ಕ್',
    ...
    'total': 'ಟೋಟಲ್',
    'currency': 'ಕರನ್ಸಿ',
    'task add successfully': 'ಟಾಸ್ಕ್ ಐಡೆಡ್ ಸಕ್ಸೆಸ್ಫುಲ್',
    'logs': 'ಲಾಗ್ಸ್',
    'select': 'ಸಿಲೆಕ್ಟ್',
    'new folder': 'ನ್ಯೂ ಫೋಲ್ಡರ್',
    'new subfolder': 'ನ್ಯೂ ಸಬ್ ಫೋಲ್ಡರ್',
    'upload files': 'ಅಪ್‌ಲೋಡ್ ಫೈಲ್ಸ್',
    'download files': 'ಡೌನ್‌ಲೋಡ್ ಫೈಲ್ಸ್',
    'download folder': 'ಡೌನ್‌ಲೋಡ್ ಫೋಲ್ಡರ್',
    'download': 'ಡೌನ್‌ಲೋಡ್',
    'share document': 'ಶೇರ್ ಡಾಕ್ಯುಮೆಂಟ್',
    'un-share document': 'ಅನ್‌ಶೇರ್ ಡಾಕ್ಯುಮೆಂಟ್',
    'share': 'ಶೇರ್',
    'view': 'ವ್ಯೂ',
    'view / preview': 'ವ್ಯೂ / ಪ್ರೀವ್ಯೂ',
    'unlock document': 'ಅನ್ಲಾಕ್ ಡಾಕ್ಯುಮೆಂಟ್',
    'lock document': 'ಲಾಕ್ ಡಾಕ್ಯುಮೆಂಟ್',
    'take photo': 'ಟೆಕ್ ಫೋಟೋ',
    'scan photo': 'ಸ್ಕ್ಯಾನ್ ಫೋಟೋ',
    'scan document': 'ಸ್ಕ್ಯಾನ್ ಡಾಕ್ಯುಮೆಂಟ್',
    'rename': 'ರೀನೇಮ್',
    'something went wrong': 'ಸಮಥಿಂಗ್ ವೆಂಟ್ ರಾಂಗ್',
  };
  ...
  static const Map<String, String> _uiGlossaryTa = {
    ...
    'day': 'டே',
    'time': 'டைம்',
    "today's date": "டுடேஸ் டேட்",
    "today's day": "டுடேஸ் டே",
    'current time': 'கரண்ட் டைம்',
    "first sign in": "ஃபர்ஸ்ட் சைன் இன்",
    "last sign out": "லாஸ்ட் சைன் அவுட்",
    ...
    'assignor': 'அசைனர்',
    'reviewer': 'ரிவ்யூஅர்',
    'company name': 'கம்பனி நேம்',
    'first name': 'ஃபர்ஸ்ட் நேம்',
    'last name': 'லாஸ்ட் நேம்',
    'client type': 'கிளையன்ட் டைப்',
    'client supply type': 'கிளையன்ட் சப்ளை டைப்',
    'client joining date': 'கிளையன்ட் ஜாயினிங் டேட்',
    'select client joining date': 'சிலெக்ட் கிளையன்ட் ஜாயினிங் டேட்',
    'std code': 'எஸ்டிடி கோடு',
    'firm type': 'ஃபர்ம் டைப்',
    'industry type': 'இண்டஸ்ட்ரி டைப்',
    'group type': 'குழூப் டைப்',
    'branch name': 'பிராஞ்ச் நேம்',
    'phone number': 'ஃபோன் நம்பர்',
    'email': 'இமெயில்',
    'pan number': 'பான் நம்பர்',
    'file number': 'ஃபைல் நம்பர்',
    'referred by': 'ரெஃபர்ட் பை',
    ...
    'client info': 'கிளையன்ட் இன்போ',
    'address': 'அட்ரஸ்',
    'owner details': 'ஓனர் டீடெயில்ஸ்',
    'add task': 'ஆட் டாஸ்க்',
    ...
    'employee': 'எம்ப்ளாயி',
    'no data found': 'நோ டேட்டா ஃபவுண்ட்',
    ...
    'total': 'டோட்டல்',
    'currency': 'கரன்சி',
    'task add successfully': 'டாஸ்க் அடெட் சக்செஸ்ஃபுல்',
    'logs': 'லாக்ஸ்',
    'select': 'சிலெக்ட்',
    'new folder': 'நியூ ஃபோல்டர்',
    'new subfolder': 'நியூ சப் ஃபோல்டர்',
    'upload files': 'அப்லோட் ஃபைல்ஸ்',
    'download files': 'டவுன்லோட் ஃபைல்ஸ்',
    'download folder': 'டவுன்லோட் ஃபோல்டர்',
    'download': 'டவுன்லோட்',
    'share document': 'ஷேர் டாக்குமென்ட்',
    'un-share document': 'அன்ஷேர் டாக்குமென்ட்',
    'share': 'ஷேர்',
    'view': 'வ்யூ',
    'view / preview': 'வ்யூ / ப்ரீவ்யூ',
    'unlock document': 'அன்லாக் டாக்குமென்ட்',
    'lock document': 'லாக் டாக்குமென்ட்',
    'take photo': 'டேக் ஃபோட்டோ',
    'scan photo': 'ஸ்கேன் ஃபோட்டோ',
    'scan document': 'ஸ்கேன் டாக்யுமென்ட்',
    'rename': 'ரீநேம்',
    'something went wrong': 'சமதிங் வென்ட் ராங்',
  };
  ...
  static const Map<String, String> _uiGlossaryTe = {
    ...
    'day': 'డే',
    'time': 'టైమ్',
    "today's date": "టుడేస్ డేట్",
    "today's day": "టుడేస్ డే",
    'current time': 'కరెంట్ టైమ్',
    "first sign in": "ఫస్ట్ సైన్ ఇన్",
    "last sign out": "లాస్ట్ సైన్ ఔట్",
    ...
    'assignor': 'అసైనర్',
    'reviewer': 'రివ్యూ అర్',
    'company name': 'కంపెనీ నేమ్',
    'first name': 'ఫస్ట్ నేమ్',
    'last name': 'లాస్ట్ నేమ్',
    'client type': 'క్లయింట్ టైప్',
    'client supply type': 'క్లయింట్ సప్లై టైప్',
    'client joining date': 'క్లయింట్ జాయినింగ్ డేట్',
    'select client joining date': 'సెలెక్ట్ క్లయింట్ జాయినింగ్ డేట్',
    'std code': 'ఎస్టీడీ కోడ్',
    'firm type': 'ఫర్మ్ టైప్',
    'industry type': 'ఇండస్ట్రీ టైప్',
    'group type': 'గ్రూప్ టైప్',
    'branch name': 'బ్రాంచ్ నేమ్',
    'phone number': 'ఫోన్ నంబర్',
    'email': 'ఇమెయిల్',
    'pan number': 'పాన్ నంబర్',
    'file number': 'ఫైల్ నంబర్',
    'referred by': 'రిఫర్డ్ బై',
    ...
    'client info': 'క్లయింట్ ఇన్ఫో',
    'address': 'అడ్రెస్',
    'owner details': 'ఓనర్ డీటెయిల్స్',
    'add task': 'యాడ్ టాస్క్',
    ...
    'total': 'టోటల్',
    'currency': 'కరెన్సీ',
    'task add successfully': 'టాస్క్ యాడెడ్ సక్సెస్‌ఫుల్',
    'logs': 'లాగ్స్',
    'select': 'సెలెక్ట్',
    'new folder': 'న్యూ ఫోల్డర్',
    'new subfolder': 'న్యూ సబ్ ఫోల్డర్',
    'upload files': 'అప్‌లోడ్ ఫైల్స్',
    'download files': 'డౌన్‌లోడ్ ఫైల్స్',
    'download folder': 'డౌన్‌లోడ్ ఫోల్డర్',
    'download': 'డౌన్‌లోడ్',
    'share document': 'షేర్ డాక్యుమెంట్',
    'un-share document': 'అన్‌షేర్ డాక్యుమెంట్',
    'share': 'షేర్',
    'view': 'వ్యూ',
    'view / preview': 'వ్యూ / ప్రీవ్యూ',
    'unlock document': 'అన్‌లాక్ డాక్యుమెంట్',
    'lock document': 'లాక్ డాక్యుమెంట్',
    'take photo': 'టేక్ ఫోటో',
    'scan photo': 'స్కాన్ ఫోటో',
    'scan document': 'స్కాన్ డాక్యుమెంట్',
    'rename': 'రీనేమ్',
    'something went wrong': 'సమథింగ్ వెంట్ రాంగ్',
  };
